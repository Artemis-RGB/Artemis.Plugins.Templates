...
namespace $safeprojectname$
{
    ...
    public class PluginDeviceProvider : DeviceProvider
    {
        ...
        public override void EnablePlugin()
        {
            ...
            MyPluginDeviceProvider.PossibleX64NativePaths.Add(Path.Combine(PluginInfo.Directory.FullName, "x64", "MyNativeSDK.dll"));
            MyPluginDeviceProvider.PossibleX86NativePaths.Add(Path.Combine(PluginInfo.Directory.FullName, "x86", "MyNativeSDK.dll"));
